...
docker pull ghcr.io/workinright/openpilot-baseaa:latest
docker tag ghcr.io/workinright/openpilot-baseaa:latest ghcr.io/workinright/openpilot-base:latest
