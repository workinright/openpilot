...
then
    ...
    mkdir -p /tmp/openpilot /tmp/scons_cache /tmp/comma_download_cache
...
sudo mount --bind "/home/$USER/work/openpilot/openpilot/.ci_cache/openpilot_cache" /tmp/openpilot_cache || true
